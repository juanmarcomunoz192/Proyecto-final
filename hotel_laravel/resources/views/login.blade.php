...
<head>
    ...
    <title>Hotel Aurora — Reserva</title>
...
<body>
            ...
            <div class="nav-links" role="navigation" aria-label="Enlaces principales">
                ...
                <button class="btn btn-primary cart-button cart-pill" onclick="viewCart()">
                    <span class="cart-icon-wrap">
                        ...
                        <svg class="cart-icon" viewBox="0 0 24 24" aria-hidden focusable="false" width="20" height="20">
                            <path fill="currentColor" d="M7 4h-2l-1 2H1v2h2l3.6 7.59-1.35 2.45C4.89 18.37 5.48 19 6.22 19h12.56v-2H6.42c-.07 0-.13-.03-.17-.08l.03-.07L7.1 16h8.45c.75 0 1.41-.41 1.75-1.03L21.92 6H6.21L5.27 4H7z"></path>
                        </svg>
                ...
                <div class="user-menu">
                    <button id="auth-btn" class="btn btn-secondary" onclick="toggleUserMenu()">Iniciar Sesión</button>
        ...
        <div class="rooms-grid" id="roomsGrid">
            ...
            <article class="room-card" aria-labelledby="r2title">
                ...
                <div class="room-footer">
                    ...
                    <button class="btn-ghost"
                        onclick="handleRoomReservation(2, 'Habitación Doble', 80)">Reservar</button>
                </div>
            </article>
    ...
    <script>
        ...
        function handleLogin(event) {
            ...
            if (user) {
                currentUser = user;
                const userData = { ...user, rememberMe: rememberMe };
                if (rememberMe) {
                    // Store for 30 days
