...
@section('maincontent')
    <!-- <form action="{{ route('users') }}" method="POST" class="p-3">
                                                                        <div class="row">
    ...
    <div class="mb-3">
        ...
        <a href="{{ route('users.crear') }}" class="btn btn-success">
            + Añadir usuario
        </a>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <a href="{{ route('users.editar', $usuario->id) }}" class="btn btn-warning btn-sm">
                                Editar
                            </a>

                            <form action="{{ route('users.borrar', $usuario->id) }}" method="POST" class="form-eliminar">
                                @csrf
                                @method('DELETE')
    ...
    @if (isset($usuarios) && $usuarios instanceof \Illuminate\Pagination\LengthAwarePaginator)
