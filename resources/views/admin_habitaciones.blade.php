...
@section('maincontent')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 form-check">
                                                    <input type="checkbox" class="form-check-input" id="esta_disponible" name="esta_disponible" value="1"
                                                        {{ isset($habitacion) && $habitacion->esta_disponible == 1 ? 'checked' : '' }}>
    ...
    <div class="mb-3">
        ...
        <a href="{{ route('habitaciones.crear') }}" class="btn btn-success">
            + Añadir Habitación
        </a>
    </div>
        ...
        <tbody>
            @foreach ($habitaciones as $habitacion)
                <tr>
                    ...
                    <td>
                        @if ($habitacion->esta_disponible == 1)
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <a href="{{ route('habitaciones.editar', $habitacion->id) }}" class="btn btn-warning btn-sm">
                                Editar
                            </a>


                            <form action="{{ route('habitaciones.borrar', $habitacion->id) }}" method="POST"
                                class="form-eliminar">
                                @csrf
                                @method('DELETE')
