...
@section('maincontent')
            ...
            <aside class="filters-sidebar">
                ...
                <form id="filterForm">
                    ...
                    <div class="filter-group">
                        ...
                        <input id="priceSlider" name="priceSlider" type="range" min="0" max="200"
                            value="200" oninput="actualizarPrecioMax(); filtrarHabitaciones()">
    ...
    <script>
        ...
        const allRooms = [{
                ...
                tipo: 'individual',
                capacidad: 1,
                nombre: 'Individual Clásica',
                precio: 45,
                badge: 'Popular',
                imagen: 'https://images.unsplash.com/photo-1554995207-c18c203602cb?q=80',
                features: ['🛏 1 cama', '📶 Wi-Fi', '🍳 Desayuno']
            },
            {
                id: 2,
                tipo: 'doble',
                ...
                precio: 70,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80',
                features: ['🛏 2 camas', '📺 Smart TV', '🛁 Baño privado']
            },
            {
                id: 3,
                tipo: 'suite',
                ...
                precio: 120,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1496412705862-e0088f16f791?q=80',
                features: ['🛏 King Size', '🍾 Minibar', '🧖 Spa']
            },
            {
                id: 4,
                tipo: 'doble',
                ...
                precio: 95,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1617093727343-3746ea41f785?q=80',
                features: ['🛏 Cama Queen', '🌆 Vistas ciudad', '📶 Wi-Fi']
            },
            {
                id: 5,
                tipo: 'suite',
                ...
                precio: 150,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1559599746-7a63f62e93a0?q=80',
                features: ['👨‍👩‍👧 4 personas', '🛋 Sala', '📺 TV 50\"']
            },
            {
                id: 6,
                tipo: 'individual',
                ...
                precio: 35,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80',
                features: ['🛏 1 cama', '🧼 Baño compartido', '📶 Wi-Fi']
            },
            {
                id: 7,
                tipo: 'suite',
                capacidad: 2,
                nombre: 'Premium Vista Ciudad',
                precio: 130,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80',
                features: ['🌆 Vistas 360°', '🛏 King Size', '🍾 Minibar']
            },
            {
                id: 8,
                tipo: 'doble',
                ...
                precio: 85,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1631049552057-403c7c6f7998?q=80',
                features: ['🌅 Balcón', '🛏 Cama Queen', '📶 Wi-Fi']
            },
            {
                id: 9,
                tipo: 'doble',
                ...
                precio: 110,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1622396481090-d8b3dd4198e0?q=80',
                features: ['🛋 Espacio amplio', '🖥 Escritorio', '🎧 Aislado']
            },
            {
                id: 10,
                tipo: 'suite',
                ...
                precio: 140,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?q=80',
                features: ['💼 Escritorio premium', '🛏 King Size', '🍾 Minibar']
            },
            {
                id: 11,
                tipo: 'individual',
                capacidad: 1,
                nombre: 'Habitación Minimalista',
                precio: 60,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1582719478236-79f6d1cf0d47?q=80',
                features: ['🛏 1 cama', '🧘 Espacio Zen', '🌿 Decoración natural']
            },
            {
                id: 12,
                tipo: 'suite',
                ...
                precio: 160,
                badge: '',
                imagen: 'https://images.unsplash.com/photo-1621393423634-836bb0c7c447?q=80',
                features: ['❤️ Jacuzzi', '🕯 Iluminación ambiente', '🍾 Botella bienvenida']
            }
        ];
