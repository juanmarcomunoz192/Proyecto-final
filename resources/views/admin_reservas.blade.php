...
@section('maincontent')
    <!-- <form action="{{ route('reservas') }}" method="POST" class="p-3">
                                                                            <div class="row">
    ...
    <div class="mb-3">
        ...
        <a href="{{ route('reservas.crear') }}" class="btn btn-success">
            + Añadir Reserva
        </a>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <a href="{{ route('reservas.editar', $reserva->id) }}" class="btn btn-warning btn-sm">
                                Editar
                            </a>
